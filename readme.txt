...
= 1.6.16 =
- Add: Product origins can be retrieved via WooCommerce REST API.
...
- Fix: Cache detection has been improved
- Fix: "Prevent redundant shipping calculations" setting has been removed
...
= 1.6.11 =
- Fix: A fix has been implemented to prevent a PHP warning in carrier rates

= 1.6.10 =
- Fix: A fix has been implemented to prevent a PHP warning

= 1.6.9 =
- Add: A new cache policy has been implemented
- Add: A new "Rates request cache timeout (seconds)" config setting has been implemented

= 1.6.8 =
- Fix: Optimization of WooCommerce script dependency loading has been implemented

= 1.6.7 =
- Add: New "Prevent shipping calculations prior to Cart or Checkout" plugin config setting has been implemented
- Fix: Cart and Checkout address fields validation has been improved (prevents unnecessary calls to Calcurates)

= 1.6.6 =
- Add: New "Is Backorder" product attribute has been implemented

= 1.6.5 =
- Add: Improvements Delivery Dates and Time Picker: following date and time format from WooCommerce settings has been implemented
