        ...
        foreach ($this->rates as $rate) {
            $rates[] = [
                ...
                'meta_data' => [
                    ...
                    'time_slot_date_required' => $this->response['metadata']['deliveryDates']['timeSlotDateRequired'] ?? null,
                    'time_slot_time_required' => $this->response['metadata']['deliveryDates']['timeSlotTimeRequired'] ?? null,
